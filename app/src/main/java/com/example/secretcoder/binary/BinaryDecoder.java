...
public class BinaryDecoder {
    ...
    public String decodeText(String message, String secret, String key, String encryptionAlgorithm) {

        // Encrypt the message using AES encryption
        String encryptedMessaged = decryptMessage(encryptionAlgorithm, secret, key);
